...
//
//     ~DirectoryWatcher() {
//         if (watchDescriptor >= 0) inotify_rm_watch(inotifyFd,
//         watchDescriptor); if (inotifyFd >= 0) close(inotifyFd);
//     }
//
//     void watch() {
...
//         }
//
//         watchDescriptor = inotify_add_watch(inotifyFd, sync_dir, IN_CREATE |
//         IN_MODIFY | IN_DELETE); if (watchDescriptor < 0) {
